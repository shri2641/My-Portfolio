...
export const PDF_CONFIG = {
  ...
  RESUME_PATH: "/documents/Shrishti_Resume.pdf",
  PORTFOLIO_PATH: "/documents/Shrishti_Portfolio.pdf",
...
export const PDF_DATA = {
  resume: {
    personalInfo: {
      name: "Shrishti Verma",
      email: "shrishtiverma107@gmail.com",
      phone: "+91 70548 59167",
      location: "Noida, India",
      linkedin: "linkedin.com/in/shrishtiverma",
      github: "github.com/shrishtiverma",
    },

    summary: `Passionate Full-Stack Developer with expertise in Java ecosystem, React, and modern web technologies. 
              Experienced in building scalable applications with microservices architecture, and cloud deployment.`,
    ...
    experience: [
      {
        ...
        location: "Noida, India",
        responsibilities: [
          "Led development of microservices architecture using  and React",
    ...
    skills: {
      technical: [
        ...
        { name: "", level: 92, category: "backend" },
    ...
    projects: [
      {
        ...
        url: "https://github.com/shri2641/ecommerce",
        highlights: [
      ...
      },
      {
        ...
        url: "https://github.com/shri2641/task-manager",
        highlights: [
