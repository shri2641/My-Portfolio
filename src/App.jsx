  ...
  const FastFallback = ({ message = 'Loading...' }) => (
    <div className="py-4 flex items-center justify-center min-h-[30vh]">
      <div className="text-center">
        <div className="w-4 h-4 border border-slate-200 dark:border-slate-700 border-t-blue-500 rounded-full animate-spin mx-auto mb-1"></div>
    ...
    <ErrorBoundary fallbackMessage="Something went wrong. Please refresh the page.">
      <Router>
        <div className="App min-h-screen relative transition-colors duration-300">
          {/* Global Background */}
          <div className="fixed inset-0 bg-slate-50 dark:bg-[#020617] transition-colors duration-300">
            {/* Elegant Background decoration */}
            <div className="absolute inset-0 w-full h-full">
              {/* Subtle radial gradient for depth */}
              <div className="absolute inset-0 bg-[radial-gradient(ellipse_80%_80%_at_50%_-20%,rgba(59,130,246,0.08),transparent)]"></div>
              
              {/* Subtle ambient light - cool tones */}
              <div className="absolute top-0 left-1/4 w-[600px] h-[600px] bg-blue-500/[0.02] rounded-full blur-[120px]"></div>
              <div className="absolute bottom-0 right-1/4 w-[500px] h-[500px] bg-blue-600/[0.015] rounded-full blur-[100px]"></div>
              
              {/* Very subtle grid pattern */}
              <div className="absolute inset-0 bg-[linear-gradient(rgba(15,23,42,0.03)_1px,transparent_1px),linear-gradient(90deg,rgba(15,23,42,0.03)_1px,transparent_1px)] dark:bg-[linear-gradient(rgba(255,255,255,0.01)_1px,transparent_1px),linear-gradient(90deg,rgba(255,255,255,0.01)_1px,transparent_1px)] bg-[size:100px_100px]"></div>
          ...
          <div className="relative z-10 text-slate-900 dark:text-neutral-100">{loading ? (
