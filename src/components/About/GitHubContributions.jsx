...
function GitHubContributions() {
  ...
  const username = 'shrishtiverma'; // GitHub username
    ...
    >
      ...
      {error && githubStats && (
        <motion.div
          ...
          className="relative overflow-hidden rounded-2xl bg-gradient-to-r from-blue-50 via-yellow-50 to-orange-50 dark:from-blue-900/10 dark:via-yellow-900/10 dark:to-orange-900/10 border border-blue-200/50 dark:border-blue-700/30 p-6"
        >
          <div className="absolute inset-0 bg-gradient-to-r from-blue-400/5 via-yellow-400/5 to-orange-400/5"></div>
          <div className="relative flex items-start space-x-4">
            <div className="flex-shrink-0 bg-blue-100 dark:bg-blue-900/30 p-2 rounded-xl">
              <svg className="w-6 h-6 text-blue-600 dark:text-blue-400" fill="currentColor" viewBox="0 0 20 20">
                <path fillRule="evenodd" d="M8.257 3.099c.765-1.36 2.722-1.36 3.486 0l5.58 9.92c.75 1.334-.213 2.98-1.742 2.98H4.42c-1.53 0-2.493-1.646-1.743-2.98l5.58-9.92zM11 13a1 1 0 11-2 0 1 1 0 012 0zm-1-8a1 1 0 00-1 1v3a1 1 0 002 0V6a1 1 0 00-1-1z" clipRule="evenodd" />
              </svg>
            </div>
            <div>
              <h4 className="font-semibold text-blue-800 dark:text-blue-300 mb-1">Using Cached Data</h4>
              <p className="text-blue-700 dark:text-blue-400 text-sm">Live GitHub data is temporarily unavailable. Showing cached information.</p>
            </div>
          </div>
        </motion.div>
      )}
