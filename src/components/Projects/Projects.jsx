              ...
              <button
                ...
                className={`px-5 py-2 rounded-full text-sm font-medium transition-all duration-300 ${
                  filter === category.value
                    ? 'bg-gradient-to-r from-blue-500 to-blue-600 text-neutral-900 shadow-lg shadow-blue-500/20'
  ...
  return (
    ...
    >
      <div className={`relative bg-neutral-900/60 backdrop-blur-sm rounded-2xl border transition-all duration-500 overflow-hidden ${
        project.featured 
          ? 'border-blue-500/20 hover:border-blue-400/40 shadow-lg shadow-blue-500/5' 
        ...
        {project.featured && (
          <div className="absolute top-4 right-4 z-10">
            <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-gradient-to-r from-blue-500 to-blue-600 text-neutral-900 text-xs font-medium">
            ...
            <div className="flex items-center gap-3">
              ...
              {project.demoUrl && (
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-400 hover:to-blue-500 text-neutral-900 text-sm font-medium transition-all duration-300 shadow-lg shadow-blue-500/15 hover:shadow-blue-500/25"
                >
