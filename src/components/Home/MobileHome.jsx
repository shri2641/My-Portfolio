...
const MobileHome = memo(() => {
  ...
  return (
    <main className="section-padding pt-20 pb-16 min-h-screen relative overflow-hidden">
      {/* Background gradient */}
      <div className="absolute inset-0 bg-gradient-to-br from-blue-600/5 via-transparent to-blue-500/5" />
      ...
      <div className="max-w-6xl mx-auto relative">
        <div className="space-y-6">
          ...
          <p className="text-neutral-400 text-sm leading-relaxed max-w-md">
            ...
            <span className="text-blue-400 font-semibold">Java & React</span>.
          </p>
          ...
          <div className="flex flex-wrap gap-3">
            <button
              ...
              className="group inline-flex items-center gap-2 bg-gradient-to-r from-blue-500 to-blue-600 text-neutral-900 px-5 py-3 rounded-xl font-semibold text-sm"
            >
              View Projects
          ...
          <div className="flex gap-3">
            <a
              ...
              className="p-2.5 text-neutral-500 hover:text-blue-400 bg-neutral-900/50 border border-neutral-800/50 rounded-xl transition-colors"
              aria-label="GitHub"
            >
              <FaGithub size={20} />
            </a>
          ...
          <div className="flex gap-0 divide-x divide-neutral-800 bg-neutral-900/50 border border-neutral-800/60 rounded-xl py-2 mt-2">
            {[
              ...
              <div key={s.l} className="flex-1 text-center px-2">
                <span className="block text-lg font-black text-blue-400">{s.v}</span>
